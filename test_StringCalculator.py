...
class TestString_Calculator(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertEqual(StringCal.add(['1', '2', '4', '8']), 15)
        self.assertEqual(StringCal.add(['1', '2', '-3','6']), 6)
        self.assertEqual(StringCal.add(['-1', '-2']), -3)

    # test case 3
    def test_add_str(self):
        self.assertEqual(StringCal.add(['1', '2', '4', '8', 'a']), 16)
        self.assertEqual(StringCal.add(['f', 'u', 'c', 'k']), 41)
        self.assertEqual(StringCal.add(['1', 'z', '4', '8', 'a']), 40)
        self.assertEqual(StringCal.add(['a', 'b', 'c', '8', 'a']), 15)
    ...
    def test_add_1000(self):
        self.assertEqual(StringCal.add(['1', '2', '4', '8','1000']), 1015)
        self.assertEqual(StringCal.add(['1', '2', '4', '8','2234']), 15)
        self.assertEqual(StringCal.add(['1', '2', '4', '8','1233','1220202','999']), 1014)
